...
export declare class AdminPhanCongGiangDayController {
    private readonly adminPhanCongService;
    constructor(adminPhanCongService: AdminPhanCongGiangDayService);
