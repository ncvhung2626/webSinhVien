// XỬ LÝ SỰ KIỆN ĐĂNG XUẤT
        ...
        $(document).ready(function () {
            ...
            $('#btnLuuGiangVien').click(function () {
                ...
                let urlApi = '/api/admin/giang-vien';
                let phuongThuc = 'POST';

                if (idGiangVienDangSua !== null) {
                    urlApi = `/api/admin/giang-vien/${idGiangVienDangSua}`;
                    phuongThuc = 'PUT';
                }
        ...
        function taiDanhSachGiangVien(page) {
            ...
            fetch(`/api/admin/giang-vien?page=${page}&limit=10&search=${encodeURIComponent(tuKhoa)}`)
                .then(response => response.json())
                .then(data => {
                    if (data.thanh_cong) {
