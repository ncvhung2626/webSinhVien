// XỬ LÝ SỰ KIỆN ĐĂNG XUẤT
        ...
        function taiDanhSachSinhVien(page) {
            ...
            fetch(`/api/admin/sinh-vien?page=${page}&limit=${gioiHanDuLieu}&search=${encodeURIComponent(tuKhoaHienTai)}`)
        ...
        $(document).ready(function () {
            ...
            $('#btnLuuSinhVien').click(function () {
                ...
                let urlApi = '/api/admin/sinh-vien';
                let phuongThuc = 'POST';

                if (idSinhVienDangSua !== null) {
                    urlApi = `/api/admin/sinh-vien/${idSinhVienDangSua}`;
                    phuongThuc = 'PUT';
                }
            ...
            $('#btnUploadExcel').click(function () {
                ...
                fetch('/api/admin/sinh-vien/import', {
                    method: 'POST',
                    body: formData
                })
                    .then(response => response.json())
